...
ActiveRecord::Schema.define(:version => 20110117063956) do
  ...
  create_table "help_fragments", :force => true do |t|
  ...
  add_index "help_fragments", ["stub"], :name => "index_help_fragments_on_stub", :unique => true
